      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            className="space-y-6"
          >
            <div className="relative p-8 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-white/[0.2] shadow-xl">
            ...
            <motion.div
              ...
              className="p-6 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-white/[0.2]"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              {highlights.map((item, index) => (
                <motion.div
                  ...
                  className="group relative p-6 rounded-2xl bg-white dark:bg-black border border-slate-200 dark:border-white/[0.2] hover:border-slate-400 dark:hover:border-slate-700 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden"
                >
                  <div className="absolute inset-0 bg-neutral-200 dark:bg-slate-800/[0.8] opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl"></div>
